...
from_dir = "C:/Users/Dhanraj/Downloads/sample"              # Add the path of you "Downloads" folder.
to_dir = "C:/Users/Dhanraj/Desktop/Downloaded_Files" #Create "Document_Files" folder in your Desktop and update the path accordingly.
